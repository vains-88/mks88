...
import kotlinx.android.synthetic.main.list_movie_item2.view.*

class RvAdapterHome(
    private val movies: List<Movie>
) : RecyclerView.Adapter<RvAdapterHome.MovieViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(
            R.layout.list_movie_item2, parent, false
        )
